  ...
  return (
    <div style={{opacity:context.isCart  || context.isMenu ? "0.4" : "1", background: context.isCart || context.isMenu ? "#000000" : "transparent"}}>
      ...
      <ImagesDiv>
        <ImgDiv1>
        <Img1 src={
          window.innerWidth < 768 ? zx7?.gallery.first.mobile : 
          window.innerWidth > 1200 ? zx7?.gallery.first.desktop : 
          zx7?.gallery.first.tablet
          
          } alt="" />
        <Img1 src={
          window.innerWidth < 768 ? zx7?.gallery.second.mobile : 
          window.innerWidth > 1200 ? zx7?.gallery.second.desktop : 
          zx7?.gallery.second.tablet
          } alt="" />
        </ImgDiv1>
        <Img3 src={
          window.innerWidth < 768 ? zx7?.gallery.third.mobile :
          window.innerWidth > 1200 ? zx7?.gallery.third.desktop : 
          zx7?.gallery.third.tablet} alt="" />
      </ImagesDiv>
      <YuoMayAlsoLikeDiv>
        ...
        <LikeDiv>
          <LikeDivImg src={
            window.innerWidth < 768 ? zx7?.others[0].image.mobile : 
            window.innerWidth > 1200 ? zx7?.others[0].image.desktop : 
            zx7?.others[0].image.tablet
            } alt="" />
        ...
        <LikeDiv2 >
          <LikeDivImg src={
            window.innerWidth < 768 ? zx7?.others[1].image.mobile : 
            window.innerWidth > 1200 ? zx7?.others[1].image.desktop : 
            zx7?.others[1].image.tablet
            } alt="" />
        ...
        <LikeDiv>
          <LikeDivImg src={
            window.innerWidth < 768 ? zx7?.others[2].image.mobile : 
            window.innerWidth > 1200 ? zx7?.others[2].image.desktop : 
            zx7?.others[2].image.tablet
            } alt="" />
