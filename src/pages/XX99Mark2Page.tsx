  ...
  return (
    <div style={{opacity:context.isCart  || context.isMenu ? "0.4" : "1", background: context.isCart || context.isMenu ? "#000000" : "transparent"}}>
      ...
      <ImagesDiv>
        <ImgDiv1>
        <Img1 src={
          window.innerWidth < 768 ? xx99mark2?.gallery.first.mobile : 
          window.innerWidth > 1200 ? xx99mark2?.gallery.first.desktop : 
          xx99mark2?.gallery.first.tablet
          
          } alt="" />
        <Img1 src={
          window.innerWidth < 768 ? xx99mark2?.gallery.second.mobile : 
          window.innerWidth > 1200 ? xx99mark2?.gallery.second.desktop : 
          xx99mark2?.gallery.second.tablet
          } alt="" />
        </ImgDiv1>
        <Img3 src={
          window.innerWidth < 768 ? xx99mark2?.gallery.third.mobile :
          window.innerWidth > 1200 ? xx99mark2?.gallery.third.desktop : 
          xx99mark2?.gallery.third.tablet} alt="" />
      </ImagesDiv>
      ...
      <YuoMayAlsoLikeDiv>
        ...
        <LikeDiv>
          <LikeDivImg src={
            window.innerWidth < 768 ? xx99mark2?.others[0].image.mobile : 
            window.innerWidth > 1200 ? xx99mark2?.others[0].image.desktop : 
            xx99mark2?.others[0].image.tablet
            } alt="" />
        ...
        <LikeDiv2 >
          <LikeDivImg src={
            window.innerWidth < 768 ? xx99mark2?.others[1].image.mobile : 
            window.innerWidth > 1200 ? xx99mark2?.others[1].image.desktop : 
            xx99mark2?.others[1].image.tablet
            } alt="" />
        ...
        <LikeDiv>
          <LikeDivImg src={
            window.innerWidth < 768 ? xx99mark2?.others[2].image.mobile : 
            window.innerWidth > 1200 ? xx99mark2?.others[2].image.desktop : 
            xx99mark2?.others[2].image.tablet
            } alt="" />
