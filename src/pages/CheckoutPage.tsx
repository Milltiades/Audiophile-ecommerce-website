    ...
    <Background blur={context.isOrder ? "blur(10px)" : "none"}>
      <BackButton onClick={() => navigate("/")}>Go Back</BackButton>
        <CheckoutDiv >
          ...
          <PaymentDiv>
            <MethodDiv border={isCircle1? "1px solid #D87D4A" : "1px solid #CFCFCF"}>
              <Circle onClick={() => {
                setIsCircle2(false)
                setIsCircle1(!isCircle1)}}><CircleLil style={{display: isCircle1 ? "flex" : "none"}}/></Circle>
              e-Money</MethodDiv>
            <MethodDiv border={isCircle2? "1px solid #D87D4A" : "1px solid #CFCFCF"}>
            <Circle onClick={() => {
              setIsCircle1(false)
              setIsCircle2(!isCircle2)}}><CircleLil style={{display: isCircle2 ? "flex" : "none"}}/></Circle>
              Cash on Delivery</MethodDiv>
